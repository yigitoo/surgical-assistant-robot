...
syms com_primary_ratio com_secondary_ratio real
% com_primary_ratio = 0.578
% com_secondary_ratio = 0.0415
syms m1 m2 m3 m4 payload real

r4x = (0.02* m4 + 0.06* payload)/(m4 + payload);

CR2 = T01* [eye(3), [Lpe * com_primary_ratio ; 0 ; Lpe * com_secondary_ratio]; 0 0 0 1];

CR3 = T02 * [eye(3), [0 ; -Lpe * com_secondary_ratio ; Lpe * com_primary_ratio]; 0 0 0 1];

CR4 = T03 * [eye(3), [Lse * com_secondary_ratio ; -Lse * com_primary_ratio ; 0]; 0 0 0 1];
...
matlabFunction(Gr, 'File', 'CalcGravCmp_MaxVariable_v2.m');
